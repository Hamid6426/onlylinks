...
export default function Locations() {
  return (
    <div class="analytics-div">
      ...
      <div class="analytics-content" data-analytics-id="locations" style="">
        <div class="analytics-link-type" style="float:right">
          <a
            href="javascript:;"
            class="analytics-link selected"
            data-var="mapType"
            data-val="country"
          >
            Country
        ...
        <div class="chart-content chart-map" data-id="locations">
          <div
            class="jvectormap-container"
            style="background-color: rgba(255, 255, 255, 0.1);"
          >
            <svg width="668" height="300">
              <defs></defs>
              <g transform="scale(0.6807254461445078) translate(40.65302596180132, 0)">
                <path
        ...
        <div class="analytics-link-view-type p-2 mt-3">
          <a
            href="javascript:;"
            class="analytics-link selected"
            data-var="view"
